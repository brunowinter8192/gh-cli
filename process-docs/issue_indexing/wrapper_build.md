...
Build session crystallizing the issues-indexing roadmap into prod. This file = what was decided + built.
...
### N = 30 (default `--limit`)
Rationale: COVERAGE, not latency (user: 11min for 100 is acceptable). Top-30 by GitHub relevance carries the signal; rank 31-100 adds no marginal insight. Flag-overridable. "31-100 adds nothing" is plausible but UNMEASURED.
