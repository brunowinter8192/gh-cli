...
2. Script runs four independent strands (repositories, developers, single_star, tripwires) in parallel threads; each is fail-fast, the others keep running.
3. Writes per-strand PASS/FAIL report to `md/test_trending.md`; prints PASS or FAIL lines, exit 1 on any failure.

## Modules

### test_trending.py (119 LOC)
