...
- **Noise strip (Keep)** — 12 sub-categories + no-space safety net; corpus peak 6,299 → 457 after round-1+2+4 reclean; 431,071 total chars removed. Content preservation: citation links, ## headings, 主題/email body all intact.
