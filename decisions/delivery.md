...
- **REST tools:** 12 visible subcommands + `get_issue_comments` (internal-only) = 13 REST modules; all via `build_headers()` (`src/github/client.py`) — `GITHUB_API_BASE`, auth, `RESULTS_PER_PAGE=20`
